...
<html lang="en">
    ...
    <body style="margin-top:70px;margin-bottom:70px">
            <nav class="navbar navbar-expand-lg bg-primary fixed-top">
                <div class="container">
                    <a class="navbar-brand text-white" href="/index.html">Ejercicio14</a>
        ...
        <?php
        show_source($filename ="../codigoPHP/ejercicio14.php");
        show_source($filename2 ="../core/funcion.php");
        ?>
