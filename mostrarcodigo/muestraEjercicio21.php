...
<html lang="en">
    ...
    <body style="margin-top:70px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">Ejercicio21</a>
        ...
        <?php
        show_source($filename = "../codigoPHP/ejercicio21.php");
         show_source($filename = "../codigoPHP/Tratamiento.php");
        ?>
