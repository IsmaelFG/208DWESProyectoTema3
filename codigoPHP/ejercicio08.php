    ...
    <head>
        ...
        <body style="margin-top:70px">
            <nav class="navbar navbar-expand-lg bg-primary fixed-top">
                <div class="container">
                    <a class="navbar-brand text-white" href="/index.html">Ejercicio08</a>
         ...
         * @since 11/10/2023
         */
        $nombreArchivo = $_SERVER['REMOTE_ADDR'];
        echo '<p>La ip del clinte: ' . $nombreArchivo . '</p>';
        ?>
