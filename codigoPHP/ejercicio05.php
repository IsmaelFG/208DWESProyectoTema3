...
<html lang="en">
    <head>
     ...
     <body style="margin-top:70px">
        ...
        $oFecha = new DateTime('2022-10-30 10:10:30');
        //formatear la marca de tiempo
        $oFechaActual->setTimestamp(time());
        // Mostrar la marca de tiempo
        echo '<p>El timestamp actual es: ' . time() . '</p>';
        echo '<p>El timestamp formateado es: ' . $oFechaActual->format('Y-m-d H:i:s') . '</p>';
         echo '<p>El timestamp del DateTime '.$oFecha->format('Y-m-d H:i:s').'  : ' . $oFecha ->getTimestamp() . '</p>';
        ?>
