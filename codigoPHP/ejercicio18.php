...
<html lang="en">
    ...
    <body style="margin-top:70px; margin-bottom: 100px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">Ejercicio18</a>
         ...
         * @since 16/10/2023
         */
        // Inicializamos el array bidimensional para representar el teatro y los 5 asientos reservados
        $ateatro = [];
