...
<html lang="en">
    <head>
         ...
         * @since 11/10/2023
         */
        //DateTime con la zona horaria Europe/Lisbon).

        $oFechaActual = new DateTime('now',new DateTimeZone('Europe/Lisbon'));

        // Formatear la fecha y hora.
        $oFechaFormateada = $oFechaActual->format('d/m/Y - H:i:s');

        // Imprimir la fecha y hora formateada.
        echo '<p>La fecha y hora actual en Oporto es: ' . $oFechaFormateada . '</p>';
        ?>
